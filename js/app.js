(() => {
    ...
    function initSliders() {
        if (document.querySelector(".big-slider__slider")) new core(".big-slider__slider", {
            modules: [ Navigation ],
            observer: true,
            observeParents: true,
            slidesPerView: 3,
        ...
        if (document.querySelector(".slider-materials__slider")) new core(".slider-materials__slider", {
            modules: [ Navigation ],
            observer: true,
            observeParents: true,
            slidesPerView: 1,
            ...
            slidesPerGroup: 1,
            navigation: {
                prevEl: ".slider-materials__arrow.swiper-button-prev",
                nextEl: ".slider-materials__arrow.swiper-button-next"
            },
            on: {}
        });
    }
